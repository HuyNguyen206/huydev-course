                ...
                <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
                    ...
                    @auth
                        @hasStartSeries($series->id)
                            <a class="btn btn-lg btn-round w-200 btn-primary mr-16" href="#"
                               data-scrollto="section-intro">Continue the series</a>
                        @else
                    ...
                    @guest
                        <a class="btn btn-lg btn-round w-200 btn-primary mr-16" href="#"
                           data-scrollto="section-intro">Start the series</a>
                    @endguest
                </div>
